            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-6">
                                    <div class="dataTables_length" id="basic_datatables_length">
                                        <label>Show
                                            <select name="basic_datatables_length" aria-controls="basic-datatables"
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="dataTables_filter" id="basic-datatables_filter">
                                        <a href="{{ route('peminjaman.generate') }}" class="btn btn-success">Cetak</a>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table id="basic-datatables" class="table display table-striped table-hover dataTable"
                                    role="grid" aria-describedby="basic-datatables_info">
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="Nama Jurusan: active to sort column descending">Nama Peminjam
                                            </th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="jurusan: active to sort column">Judul Buku</th>
                                            <th class="sorting" tabindex="0" aria-controls="multi-filter-select"
                                                rowspan="1" colspan="1" aria-sort="ascending"
                                                aria-label="kategori: active to sort column">Tanggal Kembali</th>
                                            <th class="sorting_asc" tabindex="0" aria-controls="multi-filter-select"
                                                rowspan="1" colspan="1"
                                                aria-label="Foto: active to sort column ascending"">Status</th>
                                        </tr>
                                    </thead>
                                    <tbody>
